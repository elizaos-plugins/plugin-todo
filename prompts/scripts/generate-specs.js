...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_todo", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-todo.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-todo action/provider/evaluator docs.");
}
