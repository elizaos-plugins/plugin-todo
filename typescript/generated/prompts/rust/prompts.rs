...
pub const EXTRACT_CANCELLATION_TEMPLATE: &str = r#"# Task: Extract Task Cancellation Information
...
pub const EXTRACT_COMPLETION_TEMPLATE: &str = r#"# Task: Extract Task Completion Information
...
pub const EXTRACT_CONFIRMATION_TEMPLATE: &str = r#"# Task: Extract Confirmation Intent
...
pub const EXTRACT_TASK_SELECTION_TEMPLATE: &str = r#"# Task: Extract Task Selection Information
...
pub const EXTRACT_TASK_UPDATE_TEMPLATE: &str = r#"# Task: Extract Task Update Information
...
pub const EXTRACT_TODO_TEMPLATE: &str = r#"# Task: Extract Todo Information
